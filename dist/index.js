...
var _ICalendar = require('./ICalendar');

var _ICalendar2 = _interopRequireDefault(_ICalendar);
...
function createCalendar(_ref4) {
  var productId = _ref4.productId,
      _ref4$events = _ref4.events,
      events = _ref4$events === undefined ? [] : _ref4$events;

  var cal = new _ICalendar2.default({ productId: productId, events: events });
  return cal;
}